<template>
  <header v-if="config.showHeader" class="header-wrap" :style="'background-color:' + config.setBgColor">
...
<style scoped>
  .header-wrap{position:relative;z-index:499;height:1rem;background-color:#c00;overflow:hidden;}
  ...
  .header-title{margin:0 1.25rem;height:1rem;line-height:1rem;text-align:center;font-size:.36rem;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#fff;}
</style>
